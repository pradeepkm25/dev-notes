...
System role hierarchies, granular permission catalogs, verification checklists, and runtime authorization flows.

---

## 📚 Documents in this Directory

- [`ROLES.md`](file:///d:/Dhira-Work/dev-notes/03-ROLES-AND-PERMISSIONS/ROLES.md) — System and tenant-level role hierarchy (`SUPER_ADMIN`, `TENANT_ADMIN`, `DATA_STEWARD`, `MEMBER`, `VIEWER`) and capability matrix.
